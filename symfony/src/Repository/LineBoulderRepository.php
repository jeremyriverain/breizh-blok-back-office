...
/**
 * @method LineBoulder|null find($id, $lockMode = null, $lockVersion = null)
...
class LineBoulderRepository extends ServiceEntityRepository
{
    ...
    {
        parent::__construct($registry, LineBoulder::class);
    }

    // /**
    //  * @return LineBoulder[] Returns an array of LineBoulder objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?LineBoulder
    {
        return $this->createQueryBuilder('l')
            ->andWhere('l.exampleField = :val')
            ->setParameter('val', $value)
